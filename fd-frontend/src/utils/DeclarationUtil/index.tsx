export const questions = [
  {
    bebidasAlcoholicas: "¿Ha consumido bebidas alcoholicas en las ultimas 12 horas?",
  },
  {
    medicamentosPsicoactivos:
...
export const inicial = {
  ...
  medicamentosPsicoactivos: null,
  problemaEmocional: null,
};
