                ...
                <Box boxShadow={"0px 2px 6px rgba(0, 0, 0, 0.14)"}>
                        ...
                        <Accordion>
                            ...
                            >
                                <Box flexDirection={"column"}>
                                    <Typography fontWeight={700} fontSize="16px" lineHeight={"20px"}>Repartos pendientes</Typography>
                                    <Typography sx={{ fontWeight: 400, fontSize: "12px", lineHeight: "20px" }}> No tiene repartos pendientes</Typography>
                                </Box>
                            </AccordionSummary>
                        </Accordion>
                    </Container>
                    <Container sx={{ mt: 4 }}>
                        <Accordion defaultExpanded={true}>
                            ...
                            >
                                <Box flexDirection={"column"}>
                                    <Typography fontWeight={700} fontSize="16px" lineHeight={"20px"}>Historial de repartos</Typography>
                                    <Typography sx={{ fontWeight: 400, fontSize: "12px", lineHeight: "20px" }}>Ya repartiste 58 paquetes</Typography>
                                </Box>
